...
public class SList <E extends Comparable<E>> {
	...
	public Node<Integer> mergeTwoLists(Node<Integer> p1, Node<Integer> p2){ //연습문제 2-17 두개의 정렬된 리스트 합병
	...
	//연습문제 2-20 k와 같거나 작은 리스트와 k보다 큰 리스트로 분리
	 public void splitList(Node<Integer> p, int k, SList<Integer> l1, SList<Integer> l2){ 
		 Node<Integer> head1 = new Node<Integer>(0, null);
		 Node<Integer> head2 = new Node<Integer>(0, null);
