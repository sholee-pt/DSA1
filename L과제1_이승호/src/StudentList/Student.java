...
public class Student implements Comparable<Student> {
	...
	public Student(int IDIn, String nameIn, String deptIn, int gradeIn, String emailIn, String mphoneIn) { // 생성자
		ID = IDIn; 
		name = nameIn; 
		dept = deptIn; 
		grade = gradeIn;
	...
	// LSH : getGrade(), getMphone() 메소드 추가, 각 부분에 해당하는 변수 return
	...
	// LSH : 학년, 전화번호로 비교하는 compare() 연산자 추가
