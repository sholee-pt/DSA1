...
public class ReadCSVaList {
	...
	// 파일에서 데이터를 읽어 오기
	static void ReadCSVaList(ArrList<Student> sl, String fname) throws IOException {
		...
		while(true) {
    		...
    		sl.insertLast(new Student(id, result[1], result[2], grade, result[4], result[5]));    		
	    }
	    br.close();
	}
}